...
const NavbarComponent = ({ isLoggedIn, setIsLoggedIn }) => {
  ...
  const renderNotificationPopover = (
    <Popover id="notification-popover" onMouseEnter={handleMouseEnter(setIsNotificationPopoverHovered)} onMouseLeave={handleMouseLeave(setIsNotificationPopoverHovered)}>
      <Popover.Header as="p">Notifications</Popover.Header>
      <Popover.Body>
  ...
  const renderProfilePopover = (
    <Popover id="profile-popover" onMouseEnter={handleMouseEnter(setIsProfilePopoverHovered)} onMouseLeave={handleMouseLeave(setIsProfilePopoverHovered)}>
      <Popover.Body>
        <div className="nav-item-link" onClick={() => navigate(`/profile/${userId}`)}>Profile</div>
        ...
        <div className="nav-item-link" onClick={handleLogout}>Logout</div>
      </Popover.Body>
    </Popover>
  );
      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNavDropdown">
          <ul className="navbar-nav ms-auto">
            {isLoggedIn ? (
              <>
                <li className="nav-item d-lg-none"><Link className="nav-link" to={`/profile/${userId}`}>Profile</Link></li>
                ...
                <li className="nav-item d-lg-none"><Link className="nav-link" onClick={handleLogout}>Logout</Link></li>
              </>
            ) : (
